  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl  mx-auto px-4 md:px-8">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-600 dark:text-gray-50">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`w-full md:w-1/3 max-w-sm rounded-lg  relative  ${
                plan.popular
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 right-4 rounded-full">
                  <Badge className="bg-yellow-200 rounded-full">
                    <Image
